            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">linguistique</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Langue</a></li>
                        </ol>
                    </div>
                </div>
                <!-- end -->
                ...
                <div class="col-xl-6 col-xxl-12">
                    <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Enregistrement de langue</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="{{ route('langue.add') }}" method="post" enctype="multipart/form-data" >
                                        @csrf
                                        <div class="form-group">
                                            <input type="text" name="langue" class="form-control input-default " placeholder="Langue">
                                        </div>
                                        <!--
                                        <div class="form-group">
